...
import { apiConnector } from './../../services/apiConnector'; // Assuming you have an apiConnector function.
...
const Navbar = () => {
    ...
    const fetchSublinks = async () => {
        try {
            setLoading(true);
            // Commented-out code for fetching categories from the API:
            const result = await apiConnector("GET", 'http://localhost:5173/api/v1/course/showAllCategories'); // <-- Here

            // Uncomment below if you want to use your alternative method for fetching course categories
            // const res = await fetchCourseCategories();

            setSubLinks(result);  // Assuming 'result' is the array of categories.
        } catch (error) {
